...
import { scoreTelcA1Section1 } from './scoring'
...
export async function POST(req: NextRequest) {
  try {
    console.log('[TELC-A1-LISTENING-SECTION-1 API] POST request received')
    ...
    console.log('[TELC-A1-LISTENING-SECTION-1 API] Request data:', {
      test_id,
      answers,
    ...
    console.log('[TELC-A1-LISTENING-SECTION-1 API] Database fetch result:', { testData, fetchError })
    ...
    console.log('[TELC-A1-LISTENING-SECTION-1 API] Parsed question data:', questionData)

    // Use the dedicated scoring function for TELC A1 Section 1
    const scoreResult = scoreTelcA1Section1(questionData, answers)
    
    console.log('[TELC-A1-LISTENING-SECTION-1 API] Score result:', scoreResult)
    ...
    console.error("Error in TELC A1 Listening Section 1 API:", error)
    return NextResponse.json(
...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error("Error in TELC A1 Listening Section 1 GET:", error)
