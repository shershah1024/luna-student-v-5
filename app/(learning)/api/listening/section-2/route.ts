...
import { scoreTelcA1Section2 } from './scoring'
...
export async function POST(req: NextRequest) {
  try {
    console.log('[TELC-A1-LISTENING-SECTION-2 API] POST request received')
    ...
    console.log('[TELC-A1-LISTENING-SECTION-2 API] Request data:', {
      test_id,
      answers,
    ...
    console.log('[TELC-A1-LISTENING-SECTION-2 API] Database fetch result:', { testData, fetchError })
    ...
    console.log('[TELC-A1-LISTENING-SECTION-2 API] Parsed question data:', questionData)

    // Use the dedicated scoring function for TELC A1 Section 2
    const scoreResult = scoreTelcA1Section2(questionData, answers)
    
    console.log('[TELC-A1-LISTENING-SECTION-2 API] Score result:', scoreResult)
    ...
    console.error("Error in TELC A1 Listening Section 2 API:", error)
    return NextResponse.json(
...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error("Error in TELC A1 Listening Section 2 GET:", error)
