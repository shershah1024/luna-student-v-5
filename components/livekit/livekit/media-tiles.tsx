...
const classNames = {
  ...
  agentChatOpenWithSecondTile: ['col-start-1 row-start-1', 'col-span-2', 'place-content-center'],
  // Agent
  // chatOpen: true,
  // hasSecondTile: false
  ...
  // align: x-center y-center
  agentChatClosed: ['col-start-1 row-start-1', 'col-span-2', 'place-content-center'],
  // Second tile
  // chatOpen: true,
  // hasSecondTile: true
...
export function MediaTiles({ chatOpen }: MediaTilesProps) {
  ...
  return (
    <div className="pointer-events-none absolute inset-x-0 top-[10%] z-30 h-32">
