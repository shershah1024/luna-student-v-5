...
export function AgentControlBar({
  ...
  // Initialize chatOpen based on whether chat is supported - false for speaking tests
  const [chatOpen, setChatOpen] = React.useState(capabilities.supportsChatInput);
